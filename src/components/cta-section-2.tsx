	...
	return (
		<section className='container'>
			<div className='flex flex-col items-center gap-6 rounded-xl px-6 sm:gap-10 bg-accent py-16'>
				...
				<h2 class="font-heading text-3xl font-semibold tracking-tight sm:text-4xl text-balance sm:leading-tight text-center text-primary-foreground max-w-2xl">Stay Sharp on Developer Growth</h2>
				<p class="max-w-xl text-lg text-primary-foreground/80 text-center">Join the newsletter and receive content on developer tool traction in your inbox.</p>
				<div
